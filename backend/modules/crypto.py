...
class CryptoModule:
    ...
    def get_dashboard(self):
        try:
            ...
            # Tính toán dựa trên cost_basis_vnd thực tế từ DB
            ...
            if not holdings:
                ...
                for h in holdings:
                    ...
                    # ROI tính trên giá vốn VNĐ thực tế để bao gồm cả lãi tỷ giá
    ...
    def get_group_report(self):
        # Sếp có thể copy logic tính PL từ get_dashboard vào đây để báo cáo nhóm cũng chuẩn lãi tỷ giá nhé!
        pass
